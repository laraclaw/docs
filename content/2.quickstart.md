...
This drops `config/laraclaw.php`, the migrations, and the default prompts and personas under `resources/laraclaw/`. We'll touch a few of them later.
...
- **Memory, Files, Calendar, Read Database, Tinker** — skip them all too. You don't need them yet.
