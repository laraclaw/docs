...
> [!TIP]
> If the agent still answers from thin air on a question it should have looked up, sharpen the wording in `laraclaw/instructions.md` rather than lowering `LARACLAW_MEMORY_MIN_SIMILARITY`. The usual failure is not searching at all, not searching and missing.
