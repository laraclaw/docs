...
The base system prompt lives at `resources/laraclaw/prompts/default.md` after you run `vendor:publish --tag=laraclaw`. Edit it to change the agent's default behavior across all conversations.
...
> [!NOTE]
> Enable this when you're using the [Bash](/superpowers/bash) or [Eloquent](/superpowers/eloquent) superpowers. It's the closest thing to an audit trail of what the agent has been asked to do.
