...
So after editing anything under `laraclaw/skills/`, `laraclaw/personas/`, or `resources/laraclaw/prompts/`, restart the queue worker (and Horizon supervisors, if you use them) to pick up the changes.
...
- [ ] `LARACLAW_LOG_AGENT_REQUESTS=true` if you've enabled the [Bash](/superpowers/bash) or [Eloquent](/superpowers/eloquent) superpowers
